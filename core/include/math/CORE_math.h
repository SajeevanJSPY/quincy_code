/*
        math library used in this repo
        refer: https://github.com/felselva/mathc
 */
...
/*
        macros used to enable the features
                !MATHC_NO_INT -> MATHC_USE_INT
                !MATHC_NO_FLOATING_POINT -> MATHC_USE_FLOATING_POINT
                !MATHC_NO_POINTER_STRUCT_FUNCTIONS ->
   MATHC_USE_POINTER_STRUCT_FUNCTIONS !MATHC_NO_STRUCT_FUNCTIONS ->
   MATHC_USE_STRUCT_FUNCTIONS !MATHC_NO_EASING_FUNCTIONS ->
   MATHC_USE_EASING_FUNCTIONS

                MATHC_INT_TYPE -> if !defined Int Type, use the default one
                MATH_USE_UNIONS
*/
