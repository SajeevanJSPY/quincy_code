...
bool vec3_linear_independent(mfloat_t *v0, mfloat_t *v1, mfloat_t *v2) {
    return v0[0] * v1[1] * v2[2] + v0[1] * v1[2] * v2[0] +
           v0[2] * v1[0] * v2[1] - v0[2] * v1[1] * v2[0] -
           v0[1] * v1[0] * v2[2] - v0[0] * v1[2] * v2[1];
}
...
mfloat_t *quat_inverse(mfloat_t *result, mfloat_t *q0) {
    mfloat_t l = MFLOAT_C(1.0) / (q0[0] * q0[0] + q0[1] * q0[1] +
                                  q0[2] * q0[2] + q0[3] * q0[3]);
    result[0] = -q0[0] * l;
    result[1] = -q0[1] * l;
    result[2] = -q0[2] * l;
...
struct vec2 *psvec2_subtract_f(struct vec2 *result, struct vec2 *v0,
                               mfloat_t f) {
    return (struct vec2 *)vec2_subtract_f((mfloat_t *)result, (mfloat_t *)v0,
                                          f);
}
...
struct vec2 *psvec2_multiply_f(struct vec2 *result, struct vec2 *v0,
                               mfloat_t f) {
    return (struct vec2 *)vec2_multiply_f((mfloat_t *)result, (mfloat_t *)v0,
                                          f);
}
...
struct vec3 *psvec3_subtract_f(struct vec3 *result, struct vec3 *v0,
                               mfloat_t f) {
    return (struct vec3 *)vec3_subtract_f((mfloat_t *)result, (mfloat_t *)v0,
                                          f);
}
...
struct vec3 *psvec3_multiply_f(struct vec3 *result, struct vec3 *v0,
                               mfloat_t f) {
    return (struct vec3 *)vec3_multiply_f((mfloat_t *)result, (mfloat_t *)v0,
                                          f);
}
...
struct vec4 *psvec4_subtract_f(struct vec4 *result, struct vec4 *v0,
                               mfloat_t f) {
    return (struct vec4 *)vec4_subtract_f((mfloat_t *)result, (mfloat_t *)v0,
                                          f);
}
...
struct vec4 *psvec4_multiply_f(struct vec4 *result, struct vec4 *v0,
                               mfloat_t f) {
    return (struct vec4 *)vec4_multiply_f((mfloat_t *)result, (mfloat_t *)v0,
                                          f);
}
...
struct quat *psquat_multiply_f(struct quat *result, struct quat *q0,
                               mfloat_t f) {
    return (struct quat *)quat_multiply_f((mfloat_t *)result, (mfloat_t *)q0,
                                          f);
}
...
struct mat2 *psmat2_multiply_f(struct mat2 *result, struct mat2 *m0,
                               mfloat_t f) {
    return (struct mat2 *)mat2_multiply_f((mfloat_t *)result, (mfloat_t *)m0,
                                          f);
}
...
struct mat3 *psmat3_multiply_f(struct mat3 *result, struct mat3 *m0,
                               mfloat_t f) {
    return (struct mat3 *)mat3_multiply_f((mfloat_t *)result, (mfloat_t *)m0,
                                          f);
}
...
struct mat4 *psmat4(struct mat4 *result, mfloat_t m11, mfloat_t m12,
    ...
    return (struct mat4 *)mat4((mfloat_t *)result, m11, m12, m13, m14, m21, m22,
                               m23, m24, m31, m32, m33, m34, m41, m42, m43,
                               m44);
}
...
struct mat4 *psmat4_multiply_f(struct mat4 *result, struct mat4 *m0,
                               mfloat_t f) {
    return (struct mat4 *)mat4_multiply_f((mfloat_t *)result, (mfloat_t *)m0,
                                          f);
}
